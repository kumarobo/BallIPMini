...
/*kuma*/
extern void LED_ON(int s);
extern void LED_OFF(int s);
extern void PRINT_String(char *str,int len);
// #define DEBUG_ENABLE
#define DEBUG_PutString(s) PRINT_String(s,100)
static inline void DEBUG_PutChar(char c) { char w[2]; w[0]=c; w[1]='\0'; PRINT_String(w,2); } 
